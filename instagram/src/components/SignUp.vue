<template>
  <!-- <div class="px-2 sm:px-6 lg:px-8 bg-black text-lg" style="width: 100%"> -->
    <div class="px-2 sm:px-6 lg:px-8 bg-black text-2xl bg-image">
    <div class="relative flex h-16 items-center justify-between">
      <div
        class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start"
      >
        <div class="flex flex-shrink-0 items-center" style="color: black">
          Instagram
        </div>
      </div>
    </div>
  ...
  <div class="maindiv">
    <div class="max-w-sm mx-auto">
      ...
      <div class="mt-2">
        ...
        <span style="text-decoration: underline;"><router-link to="/login">Login Now</router-link></span>
      </div>
    </div>
  </div>
</template>
